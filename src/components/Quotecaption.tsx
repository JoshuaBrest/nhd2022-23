...
export const Quotecaption = ({
    ...
    return (
        ...
        >
            <figure
                className={
                    'flex max-w-[18rem] flex-col overflow-hidden ' + className
                }
            >
                <p className='flex flex-col items-start font-bold'>
                    <svg
                        aria-hidden={true}
                        xmlns='http://www.w3.org/2000/svg'
                        viewBox='0 0 48 48'
                        className='-ml-1 -mb-1 h-10 w-10 scale-x-[-1] fill-current text-gray-500 gradient-mask-b-0 dark:text-accent-500'
                    >
                ...
                <figcaption className='w-fit max-w-full text-sm italic text-gray-700 dark:text-gray-200'>
                    {citation}
                </figcaption>
            </figure>
        </div>
